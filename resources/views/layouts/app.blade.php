    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        #toastContainer {
            ...
            z-index: 99999; display: flex; flex-direction: column; gap: .6rem; pointer-events: none;
        }
        ...
        .toast-notif {
            ...
            box-shadow: 0 10px 35px rgba(0,0,0,.14), 0 2px 8px rgba(0,0,0,.07);
            display: flex; align-items: flex-start; gap: .85rem;
            padding: 1rem 1.1rem; pointer-events: all;
